...
def create_college_csv():
    ...
    # 专业组04 - 只招男生，面向铁路公安机关
    groups04 = [
        ('ZGXSZJXYTQBw04', '专业组04', '物理组', '提前本科批B段', '化学', 'ZGXSZJXYTQBw0401', '公安视听技术（公安类）', 1),
    ]
    ...
    # 专业组05 - 只招男生，思想政治
    groups05 = [
        ('ZGXSZJXYTQBw05', '专业组05', '物理组', '提前本科批B段', '思想政治', 'ZGXSZJXYTQBw0501', '侦查学（公安类）', 1),
        ('ZGXSZJXYTQBw05', '专业组05', '物理组', '提前本科批B段', '思想政治', 'ZGXSZJXYTQBw0502', '涉外警务（公安类）', 1),
    ]
    ...
    # 专业组06 - 只招女生，思想政治
    groups06 = [
        ('ZGXSZJXYTQBw06', '专业组06', '物理组', '提前本科批B段', '思想政治', 'ZGXSZJXYTQBw0601', '侦查学（公安类）', 1),
    ]
